...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="upload_to_csv" class="btn btn-default navbar-btn">Upload to CSV</button></li>
                            <li><button type="button" id="load_from_csv" class="btn btn-default navbar-btn">Load from CSV</button></li>
        ...
        <script>
            ...
            $('#upload_to_csv').click(function(){
                window.location.href='/upload_to_csv';
            });

            $('#load_from_csv').click(function(){
                window.location.href='/load_from_csv';
            });
